...
public class Complex {
    ...
    public Complex add(Complex b) {
		...
		c.setReal(this.x + b.getReal());
		c.setImag(this.y + b.getImag());
		return c;
    }
    ...
    public Complex multiply(Complex b) {
		...
		d.setReal((this.x * b.getReal()) + (this.y * b.getImag()));
		d.setImag((this.y * b.getImag()) + (this.x * b.getImag()));
		return d;
    }
    ...
    public Complex divide(Complex b) {
        ...
        double t;
        t = b.abs2();
        div = this.multiply(b.conjugate());
        div = div.multiply(1.0 / t);
        return div;
    }
