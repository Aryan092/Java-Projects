...
public class Point {
    ...
    */
	...
	// You need to fill in this method.
		double d = Math.sqrt(Math.pow((this.X - x.getX()), 2) + Math.pow((this.Y - x.getY()), 2));
		return d;
    }
    ...
    public boolean equals(Object obj) {
    	...
    	if (obj instanceof Point) {
            Point q = (Point)obj;
                return (Math.abs(X - q.getX()) <= GEOMTOL && Math.abs(Y - q.getY()) <= GEOMTOL);
    	} else {
            return false;
        }
    }
    ...
    public static void main (String args[]) {
		...
		Point object1 = new Point (3.0,4.0);
    	Point object2 = new Point (6.0,8.0);
    	System.out.println(object1.distance(object2));
    } 
}
